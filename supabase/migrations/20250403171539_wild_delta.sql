/*
  # Fix Stage Tracking and History Issues

  1. Changes
    - Add unique constraint on prospect email per user
    - Add check constraint to prevent invalid stages
    - Add trigger to properly track stage progression
    - Clean up duplicate prospects
